      ...
      <div class="home-content">
          <div class="sales-boxes">
            ...
            <?php
              ...
              $sql = "SELECT s.stud_id, s.stud_name, s.stud_pic, a.app_id, a.stud_id, a.date FROM student s, application a WHERE s.stud_id = a.stud_id";
              $sql1 = $sql . "AND (s.stud_name LIKE '%" . $searchname . "%' OR a.app_id LIKE '%" . $searchname . "%')";
              $result = mysqli_query($conn, $sql);
            ?>
            <form class="search" action="<?php echo $_SERVER['PHP_SELF']?>?page=userview&searchkey=<?php echo $searchname?>" method="post">
              <input type="text" name="searchname" placeholder="Carian dari ID/Nama">
              <button type="submit" name="search_stud"><i class='bx bx-search'></i></button>
            </form><br>
            <!--student list-->
            <table id="list">
              <tr>
              ...
              <tr>
                ...
                <td><center>
                  <button class="button_update" onClick="window.location.href='stud_update1.php?stud_id=<?php echo $row["stud_id"] ?>'"><b>Kemaskini</b></button>
                  <button class="button_delete" onClick="window.location.href='delete_stud.php?stud_id=<?php echo $row["stud_id"] ?>'"><b>Padam</b></button><br>
                  <button class="button_view" onClick="window.location.href='verify_staff.php?app_id=<?php echo $row["app_id"] ?>'"><b>Pengesahan</b></button>
                  <button class="button_submit" onClick="window.location.href='email.php?stud_id=<?php echo $row["stud_id"] ?>'"><b>Mail</b></button>
                </center></td>
              </tr>
              <?php
                }
