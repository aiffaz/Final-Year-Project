      ...
      <div class="home-content">
        <div class="sales-boxes">
          <h3>Senarai Staf</h3><br>
            ...
            $sql = $sql . " WHERE staff_id LIKE '%" . $searchname . "%' OR staff_name LIKE '%" . $searchname . "%'";
            $result = mysqli_query($conn, $sql);
            ?>
              <form class="search" action="<?php echo $_SERVER['PHP_SELF']?>?page=userview&searchkey=<?php echo $searchname?>" method="post">
                ...
                <button type="submit" name="search_staff"><i class='bx bx-search'></i></button>
              </form><br>
            <!--staff list-->
            <table id="list">
              <tr>
              ...
              <tr>
                ...
                <td><center><?php echo '<img src="data:image;base64, '.base64_encode($row["staff_pic"]).' " style="width: 80px; height: 90px;">';?></center></td>
                <td><?php echo $row["staff_name"]?></td>
                <td><?php echo $row["staff_email"] ?></td>
                <td><center>
                  <button class="button_update" onClick="window.location.href='update_staff1.php?staff_id=<?php echo $row["staff_id"] ?>'"><b>Kemaskini</b></button><br>
                  <button class="button_delete" onClick="window.location.href='delete_staff.php?staff_id=<?php echo $row["staff_id"] ?>'"><b>Padam</b></button>
                </center></td>
              </tr>
              <?php
                }
