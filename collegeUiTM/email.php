    ...
    <div class="home-content">
      <div class="sales-boxes">
        ...
        $dbname = "college";
          ...
          $sql = "SELECT * FROM student WHERE stud_id = '$user1' ";
          $result = mysqli_query($conn, $sql);
          ?>
        <center><h3>Mail</h3></center><br>
        <?php
        if (mysqli_num_rows($result) > 0) {
          // output data of each row
          $row = mysqli_fetch_assoc($result);
        ...
        <form action="send_email.php" method="post">
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Daripada<br>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="fromEmail" id="fromEmail" value="aiffashahira@gmail.com" readonly required autofocus><br><br>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Kepada<br>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="toEmail" id="toEmail" value="<?php echo $row["stud_email"]?>" required autofocus><br><br>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tajuk<br>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="subject" id="subject" value="Tajuk: Keputusan Permohonan Kolej UiTM Perlis" readonly required autofocus><br><br>
          <!--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Mesej<br><br>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<textarea name="msg" id="msg" style="width: 877px; height: 166px">
          </textarea><br><br>-->
          <center>
            <button class="button_submit" type="submit" name="emailbtn"><b>Hantar</b></button>
          </center>
        </form>
        <?php
          } else {
